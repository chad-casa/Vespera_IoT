...
const char* mqtt_subscribe_topic = "student/CASA0014/luminaire/6"; // Topic to subscribe to
...
void LedRed() {
  WiFiDrv::digitalWrite(25, LOW);   // G off
  WiFiDrv::digitalWrite(26, HIGH);  // R on
  WiFiDrv::digitalWrite(27, LOW);   // B off
}

void LedGreen() {
  WiFiDrv::digitalWrite(25, HIGH);  // G on
  WiFiDrv::digitalWrite(26, LOW);   // R off
  WiFiDrv::digitalWrite(27, LOW);   // B off
}
...
void LedBlue() {
  WiFiDrv::digitalWrite(25, LOW);   // G off
  WiFiDrv::digitalWrite(26, LOW);   // R off
  WiFiDrv::digitalWrite(27, HIGH);  // B on
}
